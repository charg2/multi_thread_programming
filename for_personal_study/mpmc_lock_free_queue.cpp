...
// /// 인덱스(head_pos, tail_pos)가 2^63을 넘어서면 뻑남 (이건 현실적으로는 일어나기 힘들긴 함)
//
//
...
//	};
//
//	MPMCQueue() : mHeadPos(0), tail_pos(0)
//	{
...
//	void Push(T* newElem)
//	{
//		__int64 insertPos = InterlockedIncrement64(&tail_pos) - 1;
//		assert_if_false(insertPos - mHeadPos < QUEUE_MAX_SIZE); ///< overflow
//
